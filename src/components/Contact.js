...
class Contact extends Component {
    ...
    onSubmit = async (event) => {
        ...
        const response = await axios.post("http://127.0.0.1:5000/api/contact", newContact);
                    ...
                    <div className="col-11 col-lg-5">
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                <textarea className="form-control" name="description" rows="5" onChange={this.onChange}></textarea>
                            </div>
                            <button type="submit" className="btn btn-dark float-right" style={{ backgroundColor: "black" }}>Lets talk business</button>
                        </form>
                    </div>
                </div>
